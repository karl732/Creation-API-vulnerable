...
Cette mini-application est destinée **uniquement à des fins de formation** sur les vulnérabilités web (SQL injection, contrôle d'accès, élévation de privilèges, etc.).
